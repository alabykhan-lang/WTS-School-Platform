...
export const portalSsoClients = Object.freeze({
  central_registry: {
    clientId: "central_registry",
    moduleCode: "centralRegistry",
    target: "central_registry",
    redirectUri: requiredUri(portalOrigins.centralRegistry, "/"),
    postLogoutUri: portalLogoutReturnUri,
    scope: "central_registry",
    codeChallengeMethod: "S256",
  },
  result_portal: {
  ...
  notifications: {
    ...
    redirectUri: requiredUri(portalOrigins.notifications, "/"),
    postLogoutUri: portalLogoutReturnUri,
    scope: "notifications",
    codeChallengeMethod: "S256",
  },
...
const unsortedPortalModuleRegistry: PortalModuleDefinition[] = [
  {
    ...
    launchRoute: "/?sso=1&handoff=20260911c",
    ssoMethod: "pkce",
  ...
  },
  {
    ...
    launchRoute: "/portal_core.html?sso=1&handoff=20260911c",
    ssoMethod: "pkce",
  ...
  },
  {
    ...
    description: "Open the school’s protected Notification service through the central sign-in.",
    icon: "◌",
