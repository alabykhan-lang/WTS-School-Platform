...
function ModuleCard({
  ...
  return <article id={id} className="workspaceModuleCard">
    ...
    {href ? <a className="workspaceLaunchButton" href={href} target="_blank" rel="noreferrer">Open {title}<span aria-hidden="true">↗</span></a> : <span className="workspaceMutedNote">{unavailableMessage}</span>}
  </article>;
}
...
function ClassOverviewCard({
  ...
  return <article className="workspaceClassCard">
    ...
    {(showResults || showAttendance || showRegistry) ? <div className="workspaceCardActions">
      {showResults && launchHref ? <a className="workspaceLaunchButton" href={launchHref} target="_blank" rel="noreferrer">Open Results<span aria-hidden="true">↗</span></a> : null}
      {showAttendance && attendanceUrl ? <a className="workspaceTextLink" href={attendanceUrl} target="_blank" rel="noreferrer">Open Attendance ↗</a> : null}
      {showRegistry && centralRegistryUrl ? <a className="workspaceTextLink" href={centralRegistryUrl} target="_blank" rel="noreferrer">Open Administration ↗</a> : null}
    </div> : null}
  </article>;
}
...
function SubjectAssignmentCard({ assignment }: { assignment: SubjectAssignment }) {
  return <article className="workspaceAssignmentCard">
    ...
    {resultPortalUrl ? <a className="workspaceLaunchButton" href={resultPortalUrl} target="_blank" rel="noreferrer">Open Results<span aria-hidden="true">↗</span></a> : <EmptyState>Results is not connected.</EmptyState>}
  </article>;
}
