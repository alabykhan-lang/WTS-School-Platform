...
export function SiteFooter() {
  return (
    <footer className="siteFooter">
      ...
      <div><h2>Explore</h2><Link href="/">Home</Link><Link href="/about">About Us</Link><Link href="/academics">Academics</Link><Link href="/school-life">School Life</Link><Link href="/gallery">Gallery</Link><Link href="/news">News &amp; Events</Link><Link href="/staff">Staff</Link><Link href="/portal">Portal</Link><Link href="/admissions">Admissions</Link><Link href="/contact">Contact</Link></div>
