...
export function SiteFooter() {
  return (
    <footer className="siteFooter">
      ...
      <div><h2>Explore</h2><Link href="/about">About Us</Link><Link href="/academics">Academics</Link><Link href="/school-life">School Life</Link><Link href="/gallery">Gallery</Link><Link href="/admissions">Admissions</Link></div>
